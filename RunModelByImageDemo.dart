...
*/
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Correr modelo con imagenes'),
        ),
        body: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            Expanded(
              child: objDetect.isNotEmpty ? _image == null
            ...
            */
            ...
            TextButton(
              ...
              child: Text(
                "Ejecutar detección de objetos con etiquetas",
                style: TextStyle(
                  color: Colors.white,
                ),
              ),
            ...
            TextButton(
              ...
              child: Text(
                "Ejecutar detección de objetos sin etiquetas",
                style: TextStyle(
                  color: Colors.white,
                ),
              ),
