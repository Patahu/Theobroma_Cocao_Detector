...
class ClassificationModel {
  ...
  ///predice la imagen y devuelve la supuesta etiqueta que le pertenece
  ...
  ///predice la imagen pero devuelve la salida neta sin procesar
  ...
  ///predice la imagen pero devuelve la salida como probabilidades
...
class ModelObjectDetection {
  ...
  Future<List<ResultObjectDetection?>> getImagePrediction(
      ...
      {double minimumScore = 0.5,
        double IOUThershold = 0.8,
        int boxesLimit = 20}) async {
