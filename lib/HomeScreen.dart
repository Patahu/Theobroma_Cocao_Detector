...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future runObjectDetection(ImageSource im) async {
    setState(() {
      firststate = false;
      message = false;
    });
    //pick an image
    final XFile? image = await _picker.pickImage(source: im);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Cocoa app detector")),
      ...
      body: Center(
        ...
        children: [
          ...
          !firststate
              ? !message ? LoaderState() : Text("Select the Camera to Begin Detections or potho")
              : Expanded(
                  child: Container(
                      child:
